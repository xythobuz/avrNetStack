...
#define ENC28J60_CONTROL_PORT2  PORTB
#define ENC28J60_CONTROL_DDR2   DDRB
...
#define ENC28J60_CONTROL_CS PA1
#define ENC28J60_CONTROL_SO PORTB6
#define ENC28J60_CONTROL_SI PORTB5
#define ENC28J60_CONTROL_SCK PORTB7
#endif
...
void enc28j60Init(uint8_t* macaddr)
{
        ...
        CSPASSIVE; // ss=0
        //
        ENC28J60_CONTROL_DDR2  |= 1<<ENC28J60_CONTROL_SI | 1<<ENC28J60_CONTROL_SCK; // mosi, sck output
        ENC28J60_CONTROL_DDR2|= 1<<ENC28J60_CONTROL_SO; // MISO is input
        //
        ENC28J60_CONTROL_PORT2|= 1<<ENC28J60_CONTROL_SI; // MOSI low
        ENC28J60_CONTROL_PORT2|= 1<<ENC28J60_CONTROL_SCK; // SCK low
        //
